...
const siteSettingSchema = new mongoose.Schema(
  {
    ...
    hero: {
      ...
      previewImage: { type: String, default: "/shally.png" },
    ...
    videoWorkspace: {
      ...
      videoPreviewUrl: { type: String, default: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4" },
    ...
    about: {
      ...
      portraitImage: { type: String, default: "/shally.png" },
